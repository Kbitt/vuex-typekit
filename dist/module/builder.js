...
function createModule(_a) {
    var state = _a.state,
        mutations = _a.mutations,
        actions = _a.actions,
        getters = _a.getters,
        namespaced = _a.namespaced,
        modules = _a.modules
    return {
        state: state,
        namespaced: namespaced,
        modules: modules,
        mutations: mutations ? createMutations(mutations) : {},
        actions: actions ? createActions(actions) : {},
        getters: getters ? createGetters(getters) : {},
    }
}
    ...
    Object.keys(options).forEach(function (key) {
        ...
        result[k] = function (_a, payload) {
            var commit = _a.commit,
                ...
                context = __rest(_a, ['commit', 'dispatch'])
